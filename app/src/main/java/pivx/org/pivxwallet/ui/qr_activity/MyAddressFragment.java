...
//                address = module.getReceiveAddress();
                address = (Map) daps.callRPC("createPrivacyAccount");
                // todo: cleanup this
...
//                String pivxUri = PivxURI.convertToBitcoinURI(address,null,"Receive address",null);
                String pivxUri = (String)address.get("stealthaddress");
//                loadAddress(pivxUri,address.toBase58());
                loadAddress(pivxUri,pivxUri);
            }
...
//            share(address.toBase58());
            share((String)address.get("stealthaddress"));
        }else if(id == R.id.img_qr){
//            copyToClipboard(getActivity(),address.toBase58());
            copyToClipboard(getActivity(),(String)address.get("stealthaddress"));
