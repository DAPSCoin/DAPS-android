...
public class NodeAdapter extends BaseExpandableListAdapter {
    ...
    public NodeAdapter(Context context, List<String> expandableListDetail, String title) {
        this.context = context;
        this.expandableListTitle = title;
        this.expandableListDetail = new ArrayList<>(expandableListDetail);
    }

    public void updateData(List<String> expandableListDetail, String title) {
        this.expandableListDetail = new ArrayList<>(expandableListDetail);
        this.expandableListTitle = title;
    }
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.fee_list_item, null);
        }
    ...
    public View getGroupView(int listPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context.
                    getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(R.layout.fee_list_title, null);
        }
