...
public class CoinDefinition {
    ...
    // PIVX 0.12
    //
    public static final int PROTOCOL_VERSION = 70913;          //version.h PROTOCOL_VERSION
    public static final int MIN_PROTOCOL_VERSION = 70913;        //version.h MIN_PROTO_VERSION
    ...
    //  Production
    //
    public static final int AddressHeader = 20;             //base58.h CBitcoinAddress::PUBKEY_ADDRESS
    public static final int p2shHeader = 20;             //base58.h CBitcoinAddress::SCRIPT_ADDRESS
